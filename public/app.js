...
window.openProfileModal = async function(id) {
    ...
    modalBody.innerHTML = '<div style="padding: 40px; text-align: center;"><i class="ph ph-spinner animate-spin" style="font-size: 2rem;"></i><br>Loading...</div>';
    ...
    try {
        ...
        modalBody.innerHTML = `
            <div class="modal-profile-header">
                <div style="width: 100%; border-radius: 12px; overflow: hidden; height: 350px; background: #f0f0f0;">
                ...
                <div style="flex: 1; padding: 10px 0;">
                    ...
                    <p style="color: var(--primary); font-weight: 600; font-size: 1.1rem; margin-bottom: 20px; text-align: left;"><i class="ph ph-map-pin"></i> ${user.location}</p>
                    
                    <div class="modal-profile-grid">
                        <div style="background: var(--bg-main); padding: 10px; border-radius: 8px;"><strong style="color: var(--text-muted); display: block; font-size: 0.8rem; text-transform: uppercase;">Profession</strong> ${user.profession || 'Not specified'}</div>
                        <div style="background: var(--bg-main); padding: 10px; border-radius: 8px;"><strong style="color: var(--text-muted); display: block; font-size: 0.8rem; text-transform: uppercase;">Education</strong> ${user.education || 'Not specified'}</div>
                        <div style="background: var(--bg-main); padding: 10px; border-radius: 8px;"><strong style="color: var(--text-muted); display: block; font-size: 0.8rem; text-transform: uppercase;">Religion</strong> ${user.religion_practice || 'Not specified'}</div>
                        <div style="background: var(--bg-main); padding: 10px; border-radius: 8px;"><strong style="color: var(--text-muted); display: block; font-size: 0.8rem; text-transform: uppercase;">Timeline</strong> ${user.marriage_timeline || 'Not specified'}</div>
                        <div style="background: var(--bg-main); padding: 10px; border-radius: 8px;"><strong style="color: var(--text-muted); display: block; font-size: 0.8rem; text-transform: uppercase;">Height</strong> ${user.height || 'Not specified'}</div>
                        <div style="background: var(--bg-main); padding: 10px; border-radius: 8px;"><strong style="color: var(--text-muted); display: block; font-size: 0.8rem; text-transform: uppercase;">Children</strong> ${user.children_plans || 'Not specified'}</div>
                    </div>
                </div>
            </div>
            
            <div style="background: #fff; border: 1px solid var(--border); padding: 25px; border-radius: 12px; margin-bottom: 30px; text-align: left; box-shadow: var(--shadow-sm);">
            ...
            <div style="display: flex; gap: 12px; flex-wrap: wrap; position: sticky; bottom: -20px; background: white; padding: 20px; border-top: 1px solid var(--border); margin: 0 -20px -20px -20px;">
